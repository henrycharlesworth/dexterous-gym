...
MODEL_XML = dir_path+"/hand/block_catch_underarm.xml"
DEFAULT_RANGE_1 = np.array([[0.9, 1.1], [0.33, 0.5], [0.1, 0.4]])
DEFAULT_RANGE_2 = np.array([[0.9, 1.1], [0.85, 1.02], [0.1, 0.4]])

class BlockCatchUnderarm(TwoHandsEnv, utils.EzPickle):
